...
Unreloader = Rack::Unreloader.new(subclasses: %w'Roda Sequel::Model', logger: logger, reload: dev){Seq}
require_relative 'models'
Unreloader.require('app.rb'){'Seq'}
run(dev ? Unreloader : Seq.freeze.app)
